...
<body>
    ...
    <form class="container-sm d-flex align-items-center align-self-center flex-column rounded shadow-lg outside-box login-box" method="post">
        <h1 class="mt-3 mb-3 p-3 fw-bolder">Admin Login Page</h1>
        <div class="form-floating mb-3">
            <input type="email" class="form-control input-text-and-password" name="email" id="email" placeholder="#">
            <label for="email" class="label-coloring">Admin Email</label>
        </div>
        ...
        <div class="mb-3">
            <button type="submit" class="btn btn-primary ml-1" name="loginAction">Login as an Administrator</button>
        </div>
    </form>
</body>
</html>